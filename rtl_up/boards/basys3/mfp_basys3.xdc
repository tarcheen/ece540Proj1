...
set_input_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports JB[0]]
...
set_input_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports JB[3]]
...
set_output_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports {JB[2]}]
